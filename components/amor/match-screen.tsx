...
export function MatchScreen({ onClose, userImg, matchedImg, matchedName, vibeScore }: MatchScreenProps) {
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background/95 backdrop-blur-2xl anim-fade-in overflow-hidden">
      ...
      <div className="w-full px-8 flex flex-col gap-3 z-10 anim-fade-up" style={{ animationDelay: "0.45s" }}>
        <button className="group relative flex w-full items-center justify-center gap-2.5 overflow-hidden rounded-2xl py-3.5 text-[15px] font-bold text-primary-foreground transition-all active:scale-[0.98]">
